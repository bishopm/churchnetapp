...
const routes = [
  {
    ...
    children: [
      ...
      { name: 'readings', path: '/readings', component: () => import('components/Readings'), meta: { auth: true } },
      { name: 'reading', path: '/readings/:society', component: () => import('components/Reading'), meta: { auth: true } },
